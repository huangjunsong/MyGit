...
- (void)drawRunWithRect:(CGRect)rect
{
    CGContextRef context = UIGraphicsGetCurrentContext();
            NSString *emojiFilePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"faces.plist"];
        NSDictionary * dict = [[NSDictionary alloc] initWithContentsOfFile:emojiFilePath];
    NSString * imgName = [dict objectForKey:self.text];
    NSString *emojiString = [NSString stringWithFormat:@"%@",imgName];
